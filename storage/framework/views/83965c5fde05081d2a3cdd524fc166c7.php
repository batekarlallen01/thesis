    ...
    <div class="container">
     ...
     style="width: 80px; height: 80px; display: block; margin: 10px auto;">
        ...
        <div class="content">
            ...
            <p style="font-size: 16px; margin-top: 15px;">Dear <strong><?php echo e($preReg->full_name); ?></strong>,</p>
            
            <p>Thank you for submitting your pre-registration application. We have successfully received your request and documents.</p>
            
            <div class="info-box">
                <strong>📋 Service Requested:</strong> <?php echo e($preReg->service_type_name); ?><br>
                <strong>👤 Applicant Type:</strong> <?php echo e(ucfirst($preReg->applicant_type)); ?><br>
                <strong>📅 Submitted:</strong> <?php echo e($preReg->created_at->format('M d, Y h:i A')); ?>
...
</html><?php /**PATH C:\Users\kiosk\Documents\thesis\resources\views/emails/pre-registration-confirmation-pending.blade.php ENDPATH**/ ?>
...
<body>
    ...
    <div class="content">
        <p>Dear <strong>{{ $preReg->full_name }}</strong>,</p>

        <div class="alert-error">
            <strong>⚠️ Action Required:</strong> Your pre-registration needs to be revised.
        </div>

        <p>We've reviewed your application for <strong>{{ ucwords(str_replace('_', ' ', $preReg->service_type)) }}</strong>, but unfortunately we cannot proceed due to the following issues:</p>
        ...
        <div class="reasons-box">
            ...
            @if($otherReason)
                <div style="margin-top: 15px; padding: 15px; background: #fef2f2; border-radius: 4px;">
                    ...
                    <p style="margin: 5px 0 0 0;">{{ $otherReason }}</p>
                </div>
            @endif
        </div>
    ...
    <div class="footer">
        ...
        <p>&copy; {{ date('Y') }} North Caloocan City Hall. All rights reserved.</p>
    </div>
</body>
</html>
...
<body>
    ...
    <div class="content">
        ...
        <p>Your application for <strong>{{ ucwords(str_replace('_', ' ', $preReg->service_type)) }}</strong> has been reviewed and approved.</p>
    ...
    @if($preReg->qr_image_path)
        <img src="{{ $message->embed(storage_path('app/public/qrcodes/' . $preReg->qr_image_path)) }}" alt="QR Code" class="qr-code">
    @else

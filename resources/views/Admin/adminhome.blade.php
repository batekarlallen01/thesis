    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div class="flex justify-center items-center">
        <div class="login-card w-full max-w-md rounded-3xl shadow-2xl p-10 border-4 border-white flex flex-col">
         ...
         <!-- Login Form -->
<form method="POST" action="{{ route('login') }}" class="flex-1 flex flex-col justify-between">
    @csrf
    <div class="space-y-5">
        <div>
            ...
            <input 
                ...
                value="{{ old('username') }}"
                required
                class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-blue-600 transition-all duration-200 @error('username') border-red-500 @enderror"
        ...
        <div>
            ...
            <div class="relative">
                <input 
                    ...
                    name="password"
                    required
                    class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-blue-600 transition-all duration-200 @error('password') border-red-500 @enderror"

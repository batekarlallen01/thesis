...
<head>
  ...
  <title>Queue Pre-Registration Application - North Caloocan City Hall</title>
...
<body class="bg-gradient-to-br from-blue-50 to-gray-50 min-h-screen" x-data="taxDeclarationApp()">
  ...
  <div class="max-w-4xl mx-auto mt-4 p-6 md:p-8">
    <div class="text-center mb-8">
      ...
      <h1 class="text-3xl font-bold text-gray-800">Queue Pre-Registration Application</h1>
    ...
    <div class="bg-white shadow-lg rounded-xl p-6 md:p-8 space-y-6">
      ...
      <div class="bg-blue-50 p-6 rounded-lg border-2 border-blue-200">
        ...
        <div class="space-y-4">
          ...
          <!-- PWD ID Field (shows only when Yes is selected) -->
          <div x-show="form.isPwdString === 'yes'" x-transition class="pl-8">
            ...
            <p class="text-xs text-blue-700 mt-2">
              ...
              As a PWD, you will receive priority service in the queue.
            </p>
          </div>
        </div>
      </div>
  ...
  <div x-show="isSubmitting" x-transition class="fixed inset-0 bg-black bg-opacity-70 z-[60] flex items-center justify-center">
    <div class="bg-white rounded-xl p-8 shadow-2xl text-center max-w-sm">
      ...
      <p class="text-gray-600 mb-4">Please wait while we submit your application and generate your QR code</p>
  ...
  <div x-show="successModal" x-transition class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-6 text-center">
      ...
      <p class="text-gray-600 mb-6">Your request has been received. Check your email for the QR code and confirmation.</p>
  ...
  return {
    ...
    get isFormValid() {
      ...
      // If PWD is selected, PWD ID is required
  ...
  try {
    const response = await fetch('/api/pre-registration', {
      ...
      body: JSON.stringify({
        ...
        pin_numbers: {  // ADD THIS
          land: this.form.pinLand || null,
          building: this.form.pinBuilding || null,
          machinery: this.form.pinMachinery || null
        }
      })
    });
